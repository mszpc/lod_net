...
class LossCallBack(Callback):
    ...
    def __init__(self, per_print_times=1, rank_id=0, log_dir='./'):
    ...
    def step_end(self, run_context):
        ...
        if self.count >= 1:
            ...
            log_file = open(os.path.join(self.log_dir, 'loss.txt'), "a+")

            str_print = "%lu second, epoch: %s, step: %s, total_loss: %.5f" % (time_stamp_current - time_stamp_first,
